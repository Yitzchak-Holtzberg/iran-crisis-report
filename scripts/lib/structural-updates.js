...
const STRUCTURAL_FILES = {
  ...
  'reactions-iran':   { rel: 'sections/reactions-iran.html',   desc: 'Iran strike damage assessment' },
  'reactions-gulf':   { rel: 'sections/reactions-gulf.html',   desc: 'Gulf states retaliation damage' },
  'reactions-israel': { rel: 'sections/reactions-israel.html', desc: 'Israel strike outcomes & response' },
  'reactions-global': { rel: 'sections/reactions-global.html', desc: 'Global diplomatic response' },
